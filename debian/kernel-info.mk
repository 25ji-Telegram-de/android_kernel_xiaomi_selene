...
KERNEL_BOOTIMAGE_CMDLINE = bootopt=64S3,32N2,64N2 kpti=off nodebugmon noirqdebug buildvariant=user console=tty0 droidian.lvm.prefer
...
# Defconfig to use
KERNEL_DEFCONFIG = selene_defconfig
